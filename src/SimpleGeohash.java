...
public class SimpleGeohash {
	...
	public static SimpleGeohash withCharacterPrecision(double latitude, double longitude, int numberOfCharacters) {
		...
		return new SimpleGeohash(latitude, longitude, desiredPrecision);
	}
	
	private SimpleGeohash(double latitude, double longitude, int desiredPrecision) {
